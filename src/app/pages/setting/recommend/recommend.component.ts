...
export class RecommendComponent {
  ...
  */
      ...
      if (this.selectedFile != undefined) {
        ...
        this.restApiService.upload(formData).subscribe((res: any) => {
          if (res.code == "000") {
            ...
            this.onCategoryInsert(this.form["title"].value, imageUrl, this.form["image_link"].value)
          } else {
  ...
  onCategoryInsert(title: string, imageUrl: string | undefined, image_link: string,) {
    this.settingService.insertRecommend(title, imageUrl, image_link).subscribe((res: any) => {
      if (res.code == "000") {
  ...
  getAllData() {
    this.settingService
      ...
      .subscribe((res: any) => {
        if (res.code == "000") {
          this.dataList = res.data.recommend;
          this.allData = cloneDeep(res.data.recommend);
