...
export class BannerComponent {
  ...
  */
      ...
      if (this.selectedFile != undefined) {
        ...
        this.restApiService.upload(formData).subscribe((res: any) => {
          if (res.code == "000") {
            ...
            this.onCategoryInsert(imageUrl, this.form["nd"].value)
          } else {
  ...
  onCategoryInsert(imageUrl: string | undefined, noi_dung: string) {
    this.settingService.insertBanner(imageUrl, noi_dung).subscribe((res: any) => {
      if (res.code == "000") {
    ...
    this.settingService
      ...
      .subscribe((res: any) => {
        if (res.code == "000") {
          ...
          this.allData = cloneDeep(res.data.banner);
